...
async def merge_meta(meta: Meta, saved_meta: Meta) -> dict[str, Any]:
    ...
    overwrite_list = [
        ...
        'hdb', 'ptp', 'blu', 'no_season', 'no_aka', 'no_year', 'no_dub', 'no_tag', 'no_seed', 'client', 'description_link', 'description_file', 'desc', 'custom_signature', 'draft',
        'modq', 'region', 'freeleech', 'personalrelease', 'unattended', 'manual_season', 'manual_episode', 'torrent_creation', 'qbit_tag', 'qbit_cat',
        'skip_imghost_upload', 'imghost', 'manual_source', 'webdv', 'hardcoded-subs', 'dual_audio', 'manual_type', 'tvmaze_manual', 'skip_discs'
    ]
        ...
        try:
            ...
            if meta.get('comparison', False):
                ...
                if len(meta.get('image_list', [])) < cutoff and meta.get('skip_imghost_upload', False) is False:
                    ...
                    trackers_with_image_host_requirements = {'A4K', 'BHD', 'DC', 'GPW', 'HUNO', 'LST', 'MNS', 'MTV', 'OE', 'PTP', 'RF', 'RMC', 'STC', 'TVC', 'ULCX'}
                    ...
                    try:
                        ...
                        for tracker_name in relevant_trackers:
                            ...
                            if hasattr(tracker_instance, 'check_image_hosts') and not getattr(tracker_instance, 'deferred_image_host_check', False):
