...
class Args:
    ...
    def parse(self, argv: Sequence[str], meta: dict[str, Any]) -> tuple[dict[str, Any], CustomArgumentParser, list[str]]:
        ...
        parser.add_argument('--skip-discs', dest='skip_discs', action='store_true', required=False, help="Skip full disc folders (BDMV/VIDEO_TS) when processing a queue", default=False)
        ...
        parser.add_argument('-ih', '--imghost', nargs=1, required=False, help="Image Host", choices=['imgbb', 'ptpimg', 'imgbox', 'pixhost', 'lensdump', 'ptscreens', 'onlyimage', 'dalexni', 'zipline', 'passtheimage', 'seedpool_cdn', 'utppm', 'lostimg', 'reelflix'])
